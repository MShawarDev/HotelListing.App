...
using HotelListing.App.Common.Enums;
using HotelListing.App.Common.Models.Extensions;
...
public class BookingService(AppDBContext context, IUsersService usersService, IMapper mapper) : IBookingService
{
